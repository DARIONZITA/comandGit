        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <CardContent className="pt-8 pb-8 text-center space-y-6">
              ...
              <div className="space-y-3">
                <h2 className="text-3xl font-bold text-primary">Aleatório</h2>
          ...
          >
            <CardContent className="pt-8 pb-8 text-center space-y-6">
              ...
              <div className="space-y-3">
                <h2 className="text-3xl font-bold text-cyan-400">Convidar</h2>
                <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <Button 
                ...
                className="w-full py-6 text-lg font-bold bg-cyan-500 hover:bg-cyan-600 text-white"
              >
                Buscar Jogador
              </Button>
            </CardContent>
